  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="hidden mr-1 font-medium text-theme-sm xl:block">
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
          ...
          <li>
            ...
            >
              <svg className="fill-gray-500 group-hover:fill-gray-700" width="24" height="24" viewBox="0 0 24 24">
                <path
                  d="M12 8C9.79 8 8 9.79 8 12C8 14.21 9.79 16 12 16C14.21 16 16 14.21 16 12C16 9.79 14.21 8 12 8ZM12 14C10.9 14 10 13.1 10 12C10 10.9 10.9 10 12 10C13.1 10 14 10.9 14 12C14 13.1 13.1 14 12 14ZM20 10H22V14H20V10ZM2 10H4V14H2V10Z"
                  fill=""
                />
              </svg>
              Settings
