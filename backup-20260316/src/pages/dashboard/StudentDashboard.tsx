...
import EcommerceMetrics from "../../components/dashboard/EcommerceMetrics.tsx";
import RecentOrders from "../../components/dashboard/RecentOrders.tsx";
import UserMetaCard from "../../components/dashboard/UserMetaCard.tsx";
import UserInfoCard from "../../components/dashboard/UserInfoCard.tsx";
import UserAddressCard from "../../components/dashboard/UserAddressCard.tsx";
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pt-20">
      <div className="p-4 sm:p-6 lg:p-8">
        ...
        {/* Room Status Card - Only show if student has a room */}
        {studentData.room && (
